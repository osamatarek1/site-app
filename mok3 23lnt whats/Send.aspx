            ...
            <ContentTemplate>
                <div style="text-align: center; margin: 15% 1%; font-weight: 700; color: #FFCC00; font-size: x-large;">
                    ...
                    <div id="send" runat="server">
                        <asp:Button ID="Button1" runat="server" Style="margin: 4px 4px 4px 4px" class="w3-btn w3-ripple w3-blue w3-round-xlarge w3-large" OnClick="Button1_Click" OnClientClick="showIssent();" Text="Send" />
                    </div>
                ...
                <asp:Timer ID="Timer1" runat="server" Interval="7000" OnTick="Timer1_Tick" Enabled="False"></asp:Timer>
            </ContentTemplate>
        </asp:UpdatePanel>
