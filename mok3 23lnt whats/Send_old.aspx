<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Send_old.aspx.cs" Inherits="whatslink.Send_old" %>
...
<script type="text/javascript">
    ...
    function Getnumber() {
        ...
        function onSucess(result) {
            ...
            setTimeout(function () { document.getElementById('sendbtn').classList.remove("disabled"); /*alert("Hello");*/document.getElementById('senddiv').style.display = "none"; document.getElementById('number').style.display = "block"; }, 3500);
        }
