    ...
    $(document).ready(function () {
        ...
        $('#Button_copy').click(function () {
         ...
         $('#Button_getlink').click(function () {
             //alert('clicked');
             var link = "http://kookysleman-001-site1.ctempurl.com/Send.aspx?pid=" + $('#<%=HiddenField_userid.ClientID%>').val()+"&user=" + document.getElementById('FormView1_User_NameLabel').innerText + "&password=" + document.getElementById('FormView1_Pass_WordLabel').innerText;
